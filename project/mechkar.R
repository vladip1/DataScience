...
###########  Functions   ##############################################
install.packages('stats','grDevices','grDevices','rlang','utils','car','Hmisc','ROSE','pROC','ResourceSelection','sjstats','sjmisc',
          'InformationValue', 'gmodels','dplyr','tibble','givitiR','coxphw','ggplot2','xlsx','MASS')

load("../DataScience/data/BoxOffice_ff.RData")
